...
if ($_POST["JQueryFunction"] == 'novoCst') {
    $response = array();

    $codigo = $_POST['codigo'];
    $descricao = $_POST['descricao'];

    $query = "INSERT INTO FIS_CST (CODIGO, DESCRICAO, INCLUIDOPOR, INCLUIDOEM)
...
if ($_POST["JQueryFunction"] == 'editarCst') {
    $response = array();
    ...
    if (mysqli_query($conexao, $query)) {
        ...
        $selectQuery = "SELECT DESCRICAO, CODIGO, ATIVO FROM FIS_CST 
        WHERE ID = '$id'";
...
if ($_POST["JQueryFunction"] == 'inativarCst') {
    $response = array();
    ...
    if (mysqli_query($conexao, $query)) {
        // Após o update, buscar os dados atualizados incluindo a coluna ATIVO
        $selectQuery = "SELECT CODIGO, DESCRICAO, ATIVO FROM FIS_CST WHERE ID = '$id'";
...
if ($_POST["JQueryFunction"] == 'deletarCst') {
    $response = array();

    $id = $_POST['id'];

    $query = "DELETE FROM FIS_CST WHERE ID = '$id'";
