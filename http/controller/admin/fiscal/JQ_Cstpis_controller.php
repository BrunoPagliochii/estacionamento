...
if ($_POST["JQueryFunction"] == 'novoCstPis') {
    $response = array();

    $codigo = $_POST['codigo'];
    $descricao = $_POST['descricao'];

    $query = "INSERT INTO FIS_CST_PIS (CODIGO, DESCRICAO, INCLUIDOPOR, INCLUIDOEM)
...
if ($_POST["JQueryFunction"] == 'editarCstPis') {
    $response = array();
    ...
    if (mysqli_query($conexao, $query)) {
        ...
        $selectQuery = "SELECT DESCRICAO, CODIGO, ATIVO FROM FIS_CST_PIS 
        WHERE ID = '$id'";
...
if ($_POST["JQueryFunction"] == 'inativarCstPis') {
    $response = array();
    ...
    if (mysqli_query($conexao, $query)) {
        // Após o update, buscar os dados atualizados incluindo a coluna ATIVO
        $selectQuery = "SELECT CODIGO, DESCRICAO, ATIVO FROM FIS_CST_PIS WHERE ID = '$id'";
...
if ($_POST["JQueryFunction"] == 'deletarCstPis') {
    $response = array();

    $id = $_POST['id'];

    $query = "DELETE FROM FIS_CST_PIS WHERE ID = '$id'";
