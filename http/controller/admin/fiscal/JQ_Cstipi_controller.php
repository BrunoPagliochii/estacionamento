...
if ($_POST["JQueryFunction"] == 'novoCstIpi') {
    $response = array();

    $codigo = $_POST['codigo'];
    $descricao = $_POST['descricao'];

    $query = "INSERT INTO FIS_CST_IPI (CODIGO, DESCRICAO, INCLUIDOPOR, INCLUIDOEM)
...
if ($_POST["JQueryFunction"] == 'editarCstIpi') {
    $response = array();
    ...
    if (mysqli_query($conexao, $query)) {
        ...
        $selectQuery = "SELECT DESCRICAO, CODIGO, ATIVO FROM FIS_CST_IPI 
        WHERE ID = '$id'";
...
if ($_POST["JQueryFunction"] == 'inativarCstIpi') {
    $response = array();
    ...
    if (mysqli_query($conexao, $query)) {
        // Após o update, buscar os dados atualizados incluindo a coluna ATIVO
        $selectQuery = "SELECT CODIGO, DESCRICAO, ATIVO FROM FIS_CST_IPI WHERE ID = '$id'";
...
if ($_POST["JQueryFunction"] == 'deletarCstIpi') {
    $response = array();

    $id = $_POST['id'];

    $query = "DELETE FROM FIS_CST_IPI WHERE ID = '$id'";
