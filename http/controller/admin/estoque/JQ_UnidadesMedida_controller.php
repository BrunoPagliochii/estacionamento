...
if ($_POST["JQueryFunction"] == 'editarUnidadeMedida') {
    ...
    if (mysqli_query($conexao, $query)) {
        ...
        $selectQuery = "SELECT DESCRICAO, SIGLA, ATIVO FROM EST_UNIDADES_MEDIDA 
        WHERE ID = '$id' AND EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'";
...
if ($_POST["JQueryFunction"] == 'inativarUnidadeMedida') {
    $response = array();
...
if ($_POST["JQueryFunction"] == 'deletarUnidadesMedida') {
    ...
    $query = "DELETE FROM EST_UNIDADES_MEDIDA WHERE ID = '$id' AND EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'";
