...
if ($_POST["JQueryFunction"] == 'editarTiposDeMercadoria') {
    ...
    if (mysqli_query($conexao, $query)) {
        ...
        $selectQuery = "SELECT DESCRICAO, ATIVO FROM EST_TIPOS_MERCADORIA 
        WHERE ID = '$id' AND EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'";
...
if ($_POST["JQueryFunction"] == 'inativarTipoDeMercadoria') {
    $response = array();
...
if ($_POST["JQueryFunction"] == 'deletarTipoDeMercadoria') {
    ...
    $query = "DELETE FROM EST_TIPOS_MERCADORIA WHERE ID = '$id' AND EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'";
