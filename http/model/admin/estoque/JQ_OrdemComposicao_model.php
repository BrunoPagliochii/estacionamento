...
if ($_POST["JQueryFunction"] == 'preencherTabelaDeComposicao') {
    $response = array();

    $resultado = $conexao->query("SELECT ID, DESCRICAO, ATIVO FROM EST_ORDEM_COMPOSICAO WHERE EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'");
    if (!$resultado) {
