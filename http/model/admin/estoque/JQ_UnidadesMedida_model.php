...
if ($_POST["JQueryFunction"] == 'preencherTabelaDeUnidadesDeMedida') {
    $response = array();

    $resultado = $conexao->query("SELECT ID, DESCRICAO, SIGLA, ATIVO FROM EST_UNIDADES_MEDIDA WHERE EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'");
    if (!$resultado) {
