...
if ($_POST["JQueryFunction"] == 'preencherTabelaDeGrupos') {
    $response = array();

    $resultado = $conexao->query("SELECT ID, DESCRICAO, ATIVO FROM EST_GRUPOS WHERE EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'");
    if (!$resultado) {
