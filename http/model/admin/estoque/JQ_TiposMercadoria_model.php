...
if ($_POST["JQueryFunction"] == 'preencherTabelaDeTiposDeMercadoria') {
    $response = array();

    $resultado = $conexao->query("SELECT ID, DESCRICAO, ATIVO FROM EST_TIPOS_MERCADORIA WHERE EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'");
    if (!$resultado) {
