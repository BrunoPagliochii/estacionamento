...
if ($_POST["JQueryFunction"] == 'preencherTabelaDeFormasDePagamento') {
    $response = array();

    $resultado = $conexao->query("SELECT ID, DESCRICAO, ATIVO FROM FIN_FORMAS_DE_PAGAMENTO WHERE EMPRESA_ID = '$IDEMPRESAUSUARIOMODEL'");
    if (!$resultado) {
